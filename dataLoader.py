...
def get_data_loader(batch_size, dataset='mnist') -> Tuple[DataLoader, DataLoader]:
    ...
    if dataset == 'mnist':
        ...
        train_dataset = CIFAR100(download_root, transform=transform, train=True, download=True)
        test_dataset = CIFAR100(download_root, transform=transform, train=False, download=True)
